...
public class ShoppingCartFragment extends BaseFragment {
    ...
    private void showData() {
        ...
        if(list !=null&& list.size()>0) {
            ...
            //设置点击事件
            adapter.setItemClickListener(new ShoppingCartAdapter.OnItemClickListener() {
                @Override
